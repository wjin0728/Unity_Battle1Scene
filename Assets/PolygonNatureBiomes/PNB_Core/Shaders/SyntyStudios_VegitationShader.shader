...
Shader "SyntyStudios/VegitationShader"
{
	Properties
	{
		...
		[Header(Main Wind)]_TotalWindAmount("TotalWindAmount", Range( 0 , 1)) = 0
		...
		_LeafBigNoiseAmount("LeafBigNoiseAmount", Range( 0 , 1)) = 0
		[Header(LeafJitter)]_JitterFreq("JitterFreq", Range( 0 , 1)) = 0
		_JitterAmount("JitterAmount", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float simplePerlin3D57 = snoise( temp_output_51_0*_